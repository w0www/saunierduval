...
Saunierduval::Application.routes.draw do
  ...
  # Resource routes for controller notificacions
  resources :notificacions


  # Resource routes for controller financiacions
  resources :financiacions
